...
var _ = BeforeSuite(func(done Done) {
	...
	g_uuid = common.MkPVC(fmt.Sprintf("loss-test-pvc-iscsi"), "mayastor-iscsi", &g_environment.DynamicClient, &g_environment.KubeInt)
...
var _ = AfterSuite(func() {
	...
	common.RmPVC(fmt.Sprintf("loss-test-pvc-iscsi"), "mayastor-iscsi", &g_environment.DynamicClient, &g_environment.KubeInt)
