...
use spdk_sys::{
    spdk_bdev, spdk_bdev_event_type, spdk_bdev_first, spdk_bdev_get_aliases,
    spdk_bdev_get_block_size, spdk_bdev_get_buf_align, spdk_bdev_get_by_name,
    spdk_bdev_get_device_stat, spdk_bdev_get_name, spdk_bdev_get_num_blocks,
    spdk_bdev_get_product_name, spdk_bdev_get_uuid, spdk_bdev_io_stat,
    spdk_bdev_io_type_supported, spdk_bdev_next, spdk_bdev_open_ext, spdk_uuid,
    spdk_uuid_copy, spdk_uuid_generate,
};
...
use crate::{
    ...
    core::{
        ...
        uuid::Uuid,
        BlockDeviceIoStats, CoreError, Descriptor, DeviceEventType, IoType,
        ShareIscsi, ShareNvmf, UnshareIscsi, UnshareNvmf,
    },
