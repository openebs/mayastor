...
To deploy an openEBS storage platform in a K8s infra environment, you probably want to create and destroy k8s clusters ```very quickly```, without any ```pain```... regardless of where you deploy it.

In General, you probably want to deploy it into the following K8s architectures:
