//!
//! nvme-rs deals with finding attached, and connecting remote NVMe devices
//! # Disconnecting all fabric connected devices
//!```
//! use crate::nvme_rs::nvmf_subsystem::NvmeSubsystems;
//! let ss = NvmeSubsystems::new()?;
//! ss.filter_map(Result::ok)
//!     .for_each(|e| e.disconnect().unwrap());
//! ```
//!
