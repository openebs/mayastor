...
//
// TODO: Legacy operator that is replaced by NATS message bus and mayastor
// node CRD operator. It will be removed as soon as mayastor supports NATS too.

'use strict';

const assert = require('assert');
const EventEmitter = require('events');
const log = require('./logger').Logger('csi-node-operator');
